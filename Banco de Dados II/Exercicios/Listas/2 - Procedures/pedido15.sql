-- Banco de Dados pedido15 adaptado de trabalho2014 por Flávia Bertoni e Raphael Magalhães
DROP DATABASE IF EXISTS Pedido15;
CREATE DATABASE IF NOT EXISTS Pedido15;
use Pedido15;
