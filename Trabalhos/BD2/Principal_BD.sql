drop database if exists principal_metal;
create database if not exists principal_metal;
use principal_metal;
...
CREATE TABLE IF NOT EXISTS Influencias
 (
   idInfluencias INT NOT NULL,
    ...
    FOREIGN KEY (idInfluencias) REFERENCES Bandas (idBandas),
    FOREIGN KEY (idBandas) REFERENCES Bandas (idBandas)
);

-- -----------------------------------------------------
-- Tabela `Melhores_Albuns`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS melhores_Albuns
 (
  idMelhores_Albuns integer NOT NULL,
...
CREATE TABLE IF NOT EXISTS melhores_riffs
 (
  ...
  PRIMARY KEY (posicao),
  FOREIGN KEY (idMelhores_Albuns) REFERENCES Melhores_Albuns (idMelhores_Albuns)
    );
-- -----------------------------------------------------
-- Tabela `Premiacao` 
-- -----------------------------------------------------
