...
namespace LojaWin
{
    public partial class frmUsuarios : Form
    {
        ...
        // O objeto objUsuariosBll, transportárá o objeto usuario à camada de regra de negócios.
        ...
        private void btnIncluir_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Campo em branco! Entre com senha do usuário!");
                txtSenha.Focus();
            }
            else
            {
        ...
        private void ListaUsuarios()
        {
            ...
            private void FormataGrid()
            {
                try
                {
                    // Cabeçalho coluna idUsuario.
                    dgvUsuarios.Columns[0].HeaderText = "IdUsuário";

                    // Largura da coluna do grid.
                    dgvUsuarios.Columns[0].Width = 55;

                    // Cabeçalho coluna usuario.
            ...
            private void btnExcluir_Click(object sender, EventArgs e)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            lblMensagem.Text = "O usuário não pôde ser excluído!";
                        }
                    }
                    catch
                    {
